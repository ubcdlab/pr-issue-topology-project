...
from .helpers import all_structures, to_json, fetch_path, num_structures
...
@command()
@option("--closed", "include_closed", default=False, is_flag=True)
def main(include_closed: bool):
    ...
    if include_closed:
        ...
        table.add_row(
            ["Raw Counts", overall_statistics.closed_issue_merged_pr, overall_statistics.merged_pr_closed_issue]
        )
        table.add_row(
            [
