...
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/Competition.cypher --name=competition --to-csv
...
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/Decomposition.cypher --name=decomposition --to-csv
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/Duplicate_Hub.cypher --name=duplicate --to-csv
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/Improvement.cypher --name=improvement --to-csv
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/Optimization.cypher --name=optimization --to-csv
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/PR_Hub.cypher --name=pr_hub --to-csv
python -m scripts.neo4j_size_distributions --cypher=cypher_scripts/PR_Stack.cypher --name=pr_stack --to-csv
