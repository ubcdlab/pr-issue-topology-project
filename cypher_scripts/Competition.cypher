...
with i, collect(distinct pr) as pull_requests, collect (distinct pr.user) as users, collect(r) as match_relationships, collect(distinct id(i)) as known_competition
