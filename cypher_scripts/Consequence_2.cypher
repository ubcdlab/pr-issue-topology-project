...
with i, p, i2, p2, nodes, relationships, match_relationships, size(collect([i_node in nodes where i_node.type="issue" and i_node.status="closed" and i_node.number <> i.number and i_node.number <> i2.number and i_node <> i2.number and not id(i_node) in known_consq])) as not_consq, size(nodes) as len_nodes
