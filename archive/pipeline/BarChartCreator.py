    ...
    def create_vis_json_for_repo(self, target_repo):
        ...
        for index, issue in enumerate(nodes):
            ...
            for mention in issue_timeline:
                ...
                links_dict.append({"source": mention.source.issue.number, "target": issue.number})
        ...
        pattern_json = {
            "1": {"isolated": []},
            "2": {"duo_issue_issue": [], "duo_issue_pr": [], "duo_pr_pr": [], "duo_pr_issue": []},
        }
        ...
        for component in connected_components:
            ...
            if ordering == ["issue", "pull_request"]:
                pattern_json["2"]["duo_issue_pr"].append([source_node.number, sink_node.number])
